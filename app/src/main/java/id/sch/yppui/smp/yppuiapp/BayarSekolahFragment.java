...
public class BayarSekolahFragment extends Fragment {
    ...
    private void detilPembayaranSekolah() {
        ...
        View view = LayoutInflater.from(getActivity()).inflate(R.layout.dialog_detil_pembayaran_sekolah, null);
        ...
        bayarSekolahDialog.setOnShowListener(new DialogInterface.OnShowListener() {
            ...
            public void onShow(final DialogInterface dialog) {
                ...
                int sekolah = Integer.parseInt(pref.getString(Constants.HARGA_SEKOLAH,""));
                int angsuran = Integer.parseInt(pref.getString(Constants.ANGSURAN,""));
                NumberFormat format = NumberFormat.getInstance(new Locale("id", "ID"));

                harga.setText("Pembayaran sekolah melalui bank sebesar Rp. "+format.format(sekolah)+",- bisa diangsur sebanyak 2 kali dalam 1 tahun, uang muka minimal Rp. "+format.format(angsuran)+",-");
